...
<title>Aesop</title>
 ...
 function getData(pageNum){
	$("#results").load("StList.do",{"pageNum":pageNum,"field":$("#field option:selected").val(),"word":$("#word").val(),"category":"store2"},function(data){
		$("#results").html(data);
	})
}
 </script>
...
<body id="results">
	...
	<div class="mainImage">
		...
		<div class="block"></div>
		<img alt="메인" src="../images/store22.jpg" class="faImage">
	</div>
	<div class="goodsList">
	...
	<c:if test="${sessionScope.id=='store2'}">
